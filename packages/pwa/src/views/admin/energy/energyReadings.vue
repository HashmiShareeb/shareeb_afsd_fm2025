<template>
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="mt-10">
      ...
      <!-- Empty -->
      <div
        v-else-if="!energyReadings.length"
        class="flex flex-col items-center justify-center py-12 bg-gray-50 rounded-xl border border-gray-200"
      >
        <Zap class="w-10 h-10 text-yellow-400 mb-3" />
        <p class="text-center text-base text-gray-500 font-medium">
          No energy readings yet.
        </p>
        <span class="text-sm text-gray-400 mt-1">
          Start by recording a new reading above.
        </span>
      </div>
...
import { Trash, Zap } from 'lucide-vue-next'
...
} = useQuery(GET_ALL_ENERGY_READINGS)
